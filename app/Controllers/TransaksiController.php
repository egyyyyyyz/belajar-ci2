...
{  
    $data = [
        'items'    => $this->cart->contents(),
        'total'    => $this->cart->total(),
        'vouchers' => array_keys(get_voucher_list()),
    ];
...
{ 
    ...
    // Perhitungan tambahan: PPN, biaya admin, dan diskon voucher
    // dihitung dari total harga pembelian (subtotal produk), belum termasuk ongkir.
